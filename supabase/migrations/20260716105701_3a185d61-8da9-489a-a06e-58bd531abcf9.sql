...
-- These are called by triggers, cron, or backend service-role code only.

REVOKE ALL ON FUNCTION public.has_active_subscription(uuid, text) FROM PUBLIC, anon;
GRANT EXECUTE ON FUNCTION public.has_active_subscription(uuid, text) TO authenticated, service_role;

REVOKE ALL ON FUNCTION public.expire_canceled_subscriptions() FROM PUBLIC, anon, authenticated;
...
-- Trigger functions: only executed by the trigger owner, safe to lock down
